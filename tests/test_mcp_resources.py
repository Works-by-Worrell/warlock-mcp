...
def test_get_agent_persona_calls_repository(mocker):
    ...
    mocker.patch(
        "worksbyworrell.warlock.resources.agents.get_agent_repository", return_value=mock_repo
    )
...
def test_profile_resources_call_repository(mocker):
    ...
    mocker.patch(
        "worksbyworrell.warlock.resources.profiles.get_profile_repository", return_value=mock_repo
    )
...
def test_get_skill_instructions_calls_repository(mocker):
    ...
    mocker.patch(
        "worksbyworrell.warlock.resources.skills.get_skill_repository", return_value=mock_repo
    )
